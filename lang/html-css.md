...
current approach
* https://github.com/zachvalenta/markdown-2-html
```log
...
REDESIGN https://anthonyhobday.com/sideprojects/saferules/ https://github.com/asnewman/asnewman.github.io https://news.ycombinator.com/item?id=36745314 https://yossarian.net/ https://vitalik.eth.limo/general/2023/11/27/techno_optimism.html https://spwhitton.name/
* https://blakewatson.com/journal/omg-lol-an-oasis-on-the-internet/
* https://www.refactoringui.com/
* posts as hand-written notes http://worrydream.com/July2023/
> site to mirror fs e.g. writing on criticism links to psychology (people are insufficiently Artistotelian) philosophy (Rawls just golden rule; progress - Nietzsche, Wittengenstein) golf surprisingly equitable (Rahm born with clubbed foot Mickelson looked like accountant not sponsored by them Varner picture perfect median height; first world; distance; munis; college golf; geography i.e. Korea vs. US; social relations; Block; First Swing) art (Jack and gov vs. patron, US urban planning, pop music)
- [ ] add features
- [ ] rf reviews
- [ ] add review for Evans
- [ ] mv to SSG

WRITING
* schedule: book review, listen along, glossary
- [ ] post frequently https://maxread.substack.com/p/matt-yglesias-and-the-secret-of-blogging
...
alternatives
* https://news.ycombinator.com/item?id=35709494
...
💡 https://borretti.me/ https://maxlangenkamp.me/
...
- [ ] comments: HN, MR https://www.jefftk.com/p/designing-low-upkeep-software
...
* BYO https://www.youtube.com/watch?v=Ph7oJDR71Jc https://github.com/mitsuhiko/rstblog https://til.simonwillison.net/django/building-a-blog-in-django dynamic https://realpython.com/build-a-blog-from-scratch-django/
...
* _CMS_: client-server, content creation via UI, requires some dev e.g. Wordpress https://kevq.uk/the-case-for-wordpress
