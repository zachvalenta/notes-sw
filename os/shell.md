...
* howto: Vim tab groups https://www.youtube.com/watch?v=hbs7tuwpgZA [5:00]
> Vim doesn't allow naming; way to do this in Zellij?
...
* why not: copy/paste doesn't work with iTerm but Alacritty doesn't have native global hotkey, doesn't use login shell so need to manually `source $HOME/.zprofile` to get prompt https://github.com/zellij-org/zellij/issues/1434#issuecomment-2185020449
> couldn't get around with `pane command` https://zellij.dev/documentation/layout-examples
